...
class TinyImageNetTrain:
    def __init__(self, model_name = "resnet50", number_classes = 20, path="/home/wuyanru/codes/multi_source_transfer/MultiSourceExpII/model/TinyImageNet/", loadPretrain=True):
        """
    ...
    def train_all(self, epoch=10, batch_size=64, learning_rate=0.01, batch_display=50, save_freq=10):
