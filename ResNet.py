...
class ResNet(nn.Module):
    ...
    block: A sub module
    """
    def __init__(self, pretrained = True, num_classes=1000, feature_dim = 64):
        super(ResNet, self).__init__()

        self.feature = resnet50()
        if pretrained:
            self.feature.load_state_dict(torch.load("/mnt/c/Users/wuyr/Downloads/resnet50-11ad3fa6.pth"))
        # self.inplanes = 64
        ...
        self.fc1 = nn.Linear(1000, feature_dim)
